...
def aece(labels, probs, num_bins=30):
  """Implements Adaptive Expected Calibration Error."""
  return gce(labels,
             probs,
             binning_scheme='adaptive',
             max_prob=True,
...
def compute_calibration(labels, probs):
  return {
    "expected_calibration_error": ece(labels, probs, num_bins=10),
    "rms_calibration_error": rmsce(labels, probs, num_bins=10),
  }